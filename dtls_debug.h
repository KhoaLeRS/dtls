...
#define dtls_emerg(...) LWM2M_PRINTF(DB_LEVEL_INFO, __VA_ARGS__)
#define dtls_alert(...) LWM2M_PRINTF(DB_LEVEL_INFO, __VA_ARGS__)
#define dtls_crit(...) 	LWM2M_PRINTF(DB_LEVEL_INFO, __VA_ARGS__)
#define dtls_warn(...) 	LWM2M_PRINTF(DB_LEVEL_INFO, __VA_ARGS__)
#define dtls_notice(...) LWM2M_PRINTF(DB_LEVEL_INFO, __VA_ARGS__)
#define dtls_info(...) 	LWM2M_PRINTF(DB_LEVEL_INFO, __VA_ARGS__)
#define dtls_debug(...) LWM2M_PRINTF(DB_LEVEL_INFO, __VA_ARGS__)
#define dtls_debug_hexdump(name, buf, length) dtls_dsrv_hexdump_log(DTLS_LOG_DEBUG, name, buf, length, 1)
#define dtls_debug_dump(name, buf, length) dtls_dsrv_hexdump_log(DTLS_LOG_DEBUG, name, buf, length, 0)
